...
generate_available_modes(graph, unique_graph_list, directory_name + available_modes_filename, verbose)
...
generate_mode_switcher(get_mode_indices(graph), get_mode_indices_appended(graph),
...
generate_config_json(get_mode_indices(graph), get_mode_indices_appended(graph),
...
logging.info("Generate " + reconfigure_filename)
actions_list = create_actions_list(directory_name + mode_switcher_strategy_filename)
logging.info(actions_list)
generate_reconfigure(graph, actions_list, get_mode_indices(graph), get_mode_indices_appended(graph),
                     directory_name + reconfigure_filename)

logging.info("This model took " + str(time.time() - start_time) + "s")
